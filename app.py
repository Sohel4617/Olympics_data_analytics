...
st.sidebar.image("https://wallpapercave.com/wp/wp4216271.jpg")
...
if user_menu == "Overall Analysis":
    ...
    x = helper.most_suceesful(df,selected_sport)
    st.table(x)
...
if user_menu == 'Athlete Wise Analysis':
    ...
    # Assuming 'final' is your DataFrame with columns 'Year', 'Male', and 'Female'
    fig = go.Figure()

    # Add line traces for 'Male' and 'Female'
    fig.add_trace(go.Scatter(x=final['Year'], y=final['Male'], mode='lines', name='Male'))
    fig.add_trace(go.Scatter(x=final['Year'], y=final['female'], mode='lines', name='female'))
    st.plotly_chart(fig)